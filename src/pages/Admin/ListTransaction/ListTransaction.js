          ...
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            <TableHead>
              <TableRow>
                ...
                <TableCell className="link-image text-elipsis" width={100}>
                  Bukti Transfer
                </TableCell>
                ...
                if (status !== "Waiting payment") {
                  return (
                    <TableRow key={id}>
                      ...
                      <TableCell className="link-image text-elipsis">
                        <a href={attachment} target="_blank">
                          {attachment}
                        </a>{" "}
                      </TableCell>
                      <TableCell>
                        <span className={"color-" + color}>{status}</span>
                      </TableCell>
                      <TableCell
                        align="center"
                      ...
                      >
                        {status === "Approve" ? (
                          ...
                          <img
                            src={IconSearch}
                            className="c-pointer"
                            alt="for help you to search something"
                          />
                        )}
                      </TableCell>
                    </TableRow>
