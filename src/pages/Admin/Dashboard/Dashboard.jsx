    ...
    <div className="header-default">
          ...
          <div className="main">
            ...
            <TableContainer component={Paper}>
              <Table sx={{ width: "100%" }} aria-label="simple table">
                ...
                <TableBody>
                  {dataUser.map((item) => {
                    const totalTransByUser = trans.filter(
                      (users) => users.user.id === item.id
                    );
                    ...
                    return (
                      <TableRow>
                        ...
                        <TableCell align="center">
                          {totalTransByUser ? totalTransByUser.length : 0}
                        </TableCell>
                        <TableCell align="center">
                          {totalTransByUser.length > 2 ? "Loyal" : "Regular"}
                        </TableCell>
                      </TableRow>
                    );
                  })}
      ...
      >
        <Card sx={{ width: 500, maxWidth: "90%", p: "10px 20px" }}>
          <CardContent>
            <p>
              Are you sure about that? You can change it again if you are not
              sure
            </p>
            <Gap height={20} />
          </CardContent>
          <CardActions>
            ...
            >
              <div style={{ marginLeft: "10px" }}>
                <Button variant="contained" sx={warningButton}>
                  cancel
                </Button>
              </div>
            </div>
