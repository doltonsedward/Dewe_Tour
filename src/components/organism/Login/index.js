...
// mui component
import { Button, Backdrop, Modal, Fade } from "@mui/material";
          ...
          <div>
            <div className="modal">
              <div className="heading-modal">
                <img
                  className="icon-palm__login"
                  src={IconPalm2}
                  alt="login with google"
                />
                <img
                  className="icon-hibicus__login"
                  src={IconHibicus2}
                  alt="you can login with google here"
                />
              </div>
              <div className="content-modal">
                <form onSubmit={loginSession} onKeyDown={handleEnterPressed}>
                  ...
                  <Gap height={23} />
                  <p className="text-center disclamer">
